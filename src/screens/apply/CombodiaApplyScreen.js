    ...
    try {
      ...
      await applicationRef.set({
        ...
        documents: {
          ...
          bankStatementUrl: t.documents.bankStatement?.uri || null,
          hotelConfirmationUrl: t.documents.hotelConfirmation?.uri || null,
        },
        status: "submitted",
    ...
    <ScreenWrapper>
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Combodia Visa Application</Text>
