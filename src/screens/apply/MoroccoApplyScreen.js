...
export default function MoroccoApplyScreen({ navigation }) {
  ...
  const submit = async () => {
    ...
    try {
      ...
      const applicationId = `morocco_${Date.now()}`;
      ...
      console.log("Morocco submit error:", error);
